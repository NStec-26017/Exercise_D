				...
				<div class="card text-center">
					<div class="card-body">
						...
						<form method="post">
							...
							<br>
							<input type="hidden" name="deptId" value="${delDeptCheckViewData.deptId}">
							<input type="hidden" name="name" value="${delDeptCheckViewData.deptName}">
							<div style="display: inline-flex;">
								<button type="submit" formaction="<%=request.getContextPath()%>/deptdeletecheck"
